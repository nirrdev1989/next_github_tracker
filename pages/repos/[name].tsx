...
import Badge from "../../components/util-components/Badge/Badge"
import P from "../../components/util-components/P/P"
import Title from "../../components/util-components/Titles/Title"
import { DateIcon, FollowIcon, IssueIcon, languageIcons, StarIcon } from "../../icons"
...
function RepoPage({ }: RepoPageProps): JSX.Element {
   return (
      <>
...
export const getServerSideProps: GetServerSideProps<RepoPageProps> = async (context) => {
   ...
   // console.log(context)
   // const { data } = await Axios.get(`https://api.github.com/repos/${context.query.user}/${context.query.name}`)
   // const { data } = await Axios.get(`https://api.github.com/repos/${context.query.user}/${context.query.name}/events`)
